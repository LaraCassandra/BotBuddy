<!-- REPLACE ALL THE [LaraCassandra] TEXT WITH YOUR GITHUB PROFILE NAME & THE [BotBuddy] WITH THE NAME OF YOUR GITHUB PROJECT -->
...
See the [open issues](https://github.com/LaraCassandra/BotBuddy/issues) for a list of proposed features (and known issues).
